...
<script>
  document.getElementById("enquiryForm").addEventListener("submit", function (e) {
    ...
    const phoneNumber = "+917010431898";
...
<script>
  function whatsappForm(e) {
    ...
    const phoneNumber = "917010431898"; // remove '+'
  ...
  <div class="container py-5">
    <div class="row g-5">
      <div class="col-lg-3 col-md-6">
        ...
        <p class="mb-2">
          <i class="fa fa-map-marker-alt me-3"></i>6/118/A southstreet , andarkulam, RAMAPURAM POST KANYAKUMARI
          TAMILNADU INDIA (629302)
        </p>
        <p class="mb-2">
          <i class="fa fa-phone-alt me-3"></i>+91 7010431898
        </p>
        <p class="mb-2">
          <i class="fa fa-envelope me-3"></i> babishmass@gmail.com
        </p>
    ...
    <div class="copyright">
      <div class="row">
        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
          &copy;
          <a class="border-bottom" href="#">Cocofern</a>, All Right Reserved.
        </div>
